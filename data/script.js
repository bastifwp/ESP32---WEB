...
function getReadings(){
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      var light = myObj.light;
      var tds = myObj.tds;
      /* myObj should be something like
	{
	  "temperature1" : str,
          "temperature2" : str,
          "light" : str,
...
if (!!window.EventSource) {
  ...
  source.addEventListener('new_readings', function(e) {
    ...
    console.log(myObj);
    gaugeTemp1.value = myObj.temperature1;
    gaugeTemp2.value = myObj.temperature2;
    gaugeLight.value = myObj.light;
    gaugeTds.value = myObj.tds;
  }, false);
